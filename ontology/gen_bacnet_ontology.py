...
# Defint ontology IRI
ontology_iri = URIRef("http://data.ashrae.org/bacnet")
g.add((ontology_iri, RDF.type, OWL.Ontology))
g.add((BACNET.BACNET, RDF.type, OWL.Class))
g.add((BACNET.BACNET, RDFS.subClassOf, OWL.Thing))
...
g.add((bacnet_Device, RDFS.subClassOf, BACNET.BACNET))
g.add((bacnet_Point, RDF.type, OWL.Class))
g.add((bacnet_Point, RDFS.subClassOf, BACNET.BACNET))
...
g.serialize('bacnet.ttl', format='turtle')